...
public class RestaurantDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            String itemId = getIntent().getStringExtra(RestaurantDetailFragment.ARG_ITEM_ID);
            RestaurantDetailFragment fragment = RestaurantDetailFragment.newInstance(itemId);
